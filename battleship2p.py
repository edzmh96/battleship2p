...
for matches in range(1000):
    ...
    for i in range(5):
        ...
        if selection == "1" or selection == "2":
            ...
            exit = True
            break
    	elif (selection != "1" or selection != "2") or selection.lower() != "q" :
    		print "Sys: Please choose a valid option"
        if i == 4:
    ...
    for i in range(5):
        ...
        if gamemode == "1" or gamemode == "2" or gamemode == "3":
            ...
            exit = True
            break
        elif gamemode != "1"  or gamemode != "2" or gamemode != "3" or gamemode.lower() != "q":
        	print "Sys: Please enter a valid option."
        if i == 4:
                        ...
                        if player == 1:
                            ...
                            if search_coor(tmp_x[f], tmp_y[f], ship2):
                                ...
                                if ship_size2[tmp_x] == 1:
                                    ...
                                    if len(ship2[tmp_x]) > 1:
                                        txt += "How dare you! That's my mothership!\n"
                                    else:
                                        if ship_left2 > 1:
                                            txt += "WTF! You sunk one of my mothership! Beware of my revenge!!\n"
                                            revenge = True
                                        else:
                                            txt = ""
                                            ch2 = ch2[:5] + "Nooooooo!!!"
                ...
                if player == 1:
                    if recharge1:
                        ...
                        if game_board2[guess_row][guess_col] == "X":
                            ...
                            if ship_size2[tmp_x] == 1:
                                if ship_left2 > 1:
                                    ch2 = ch2[:5] + "Oh! No! You sunk one of my battleships!"
                                else:
                                    ch2 = ch2[:5] + "Nooooooo!!!"
                                ship_left2 -= 1
                            elif ship_size2[tmp_x] == 2:
                                ...
                                if len(ship2[tmp_x]) > 1:
                                    ch2 = ch2[:5] + "How dare you! That's my mothership!"
                                    cf = True           # change formation when damaged
                                else:
                                    if ship_left2 > 1:
                                        ch2 = ch2[:5] + "WTF! You sunk one of my mothership! Beware of my revenge!!"
                                        revenge = True
                                    else:
                                        ch2 = ch2[:5] + "Nooooooo!!!"
                                    ship_left2 -= 1
                    ...
                    if recharge2:
                        ...
                        if game_board1[guess_row][guess_col] == "X":
                            ...
                            if ship_size1[tmp_x] == 1:
                                ...
                                if len(ship1[tmp_x]) > 1:
                                    ch1 = ch1[:5] + "How dare you! That's my mothership!"
                                    cf = True           # change formation when damaged
                                else:
                                    if ship_left1 > 1:
                                        ch1 = ch1[:5] + "WTF! You sunk one of my mothership! Beware of my revenge!!"
                                        revenge = True
                                    else:
                                        ch1 = ch1[:5] + "Nooooooo!!!"
                                    ship_left1 -= 1
